...
function App() {
    ...
    const changeDataCategoryToCharacters = () => {
        setGetDataCategory("characters");
    };
    const changeDataCategoryToBooks = () => {
        setGetDataCategory("books");
    };
    const changeDataCategoryToHouses = () => {
        setGetDataCategory("houses");
    };
...
document.body.style.backgroundImage = "url('https://wallpaperaccess.com/full/122977.jpg')";
  ...
  <form className="search-bar"> 
        <input type="text" id="search" name="search" placeholder="Enter search..."/>
            ...
            value="standard"
            onClick={changeDataCategoryToCharacters}
            type="submit"
          > Characters
          </button>
            <button
            value="standard"
            onClick={changeDataCategoryToBooks}
            type="submit"
          > Books
          </button>
            <button
            value="standard"
            onClick={changeDataCategoryToHouses}
            type="submit"
          > Houses
          </button>
        </div>
